                                ...
                                <div className="modal-body">
                                  <form action="" className="form-horizontal" onSubmit={this.handleSubmit}>
                                    <div className="form-group">
                                        <label className="contact-text">御社名</label>
                                    ...
                                    <div className="form-group">
                                        <label className="contact-text">ご担当者名</label>
                                    ...
                                    <div className="form-group">
                                        <label className="contact-text">メールアドレス</label>
                                    ...
                                    <div className="form-group">
                                        <label className="contact-text">電話番号</label>
                                    ...
                                    <div className="form-group">
                                        <label className="contact-text">お問い合わせ内容</label>
                                        <textarea name="user-message" id="description-of-contact" value={this.state.description} onChange={this.handleChangeDescription} className="grey-form form-control" cols="20" rows="7" placeholder="内容を記入してください"></textarea>
                                    </div>
